...
**Next:** [Step 10: Property Formatting Using Data Types](../10/index.html "OpenUI5 offers a set of simple data types, including Boolean, Currency, Date and Float.")

**Previous:** [Step 8: Binding Paths: Accessing Properties in Hierarchically Structured Models](../08/index.html "In Step 6, we stated that the fields in a resource model are arranged in a flat structure; in other words, there is no hierarchy of properties.")
