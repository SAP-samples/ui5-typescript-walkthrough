---
title: UI5 Tutorials
permalink: databinding/build/10/README.html
---
...
**Next:** [Step 11: Validation Using `sap/ui/core/Messaging`](../11/index.html "Up to this point, we've created a currency field that formats itself correctly. The currency data type can also validate user input to ensure it meets currency requirements.")

**Previous:** [Step 9: Formatting Values](../09/index.html "We'd also like to provide our users with a way of contacting Harry Hawk, so we're adding a link that sends an e-mail to Harry.")
