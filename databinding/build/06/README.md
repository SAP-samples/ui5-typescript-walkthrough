...
**Next:** [Step 7: \(Optional\) Resource Bundles and Multiple Languages](../07/index.html "Resource bundles exist to enable an app to run in multiple languages without the need to change any code.")

**Previous:** [Step 5: One-Way Data Binding](../05/index.html "Unlike the two-way binding behavior we've seen, one-way data binding is also possible.")
