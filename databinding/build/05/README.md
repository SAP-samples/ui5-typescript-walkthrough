...
**Next:** [Step 6: Resource Models](../06/index.html "Business applications often require language-specific \(translatable\) text used as labels and descriptions on the user interface.")

**Previous:** [Step 4: Two-Way Data Binding](../04/index.html "In the examples we've looked at so far, we've displayed the value of a model property using a read-only field.")
