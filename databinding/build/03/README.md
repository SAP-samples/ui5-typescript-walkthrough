...
**Next:** [Step 4: Two-Way Data Binding](../04/index.html "In the examples we've looked at so far, we've displayed the value of a model property using a read-only field.")

**Previous:** [Step 2: Creating a Model](../02/index.html "In this step, we create a model.")
