---
title: UI5 Tutorials
permalink: databinding/build/08/README.html
---
...
**Next:** [Step 9: Formatting Values](../09/index.html "We'd also like to provide our users with a way of contacting Harry Hawk, so we're adding a link that sends an e-mail to Harry.")

**Previous:** [Step 7: \(Optional\) Resource Bundles and Multiple Languages](../07/index.html "Resource bundles exist to enable an app to run in multiple languages without the need to change any code.")
